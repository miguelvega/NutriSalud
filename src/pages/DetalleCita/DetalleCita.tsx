      ...
      <div className="detalle-cita-card">
        ...
        <div className="detalle-cita-actions-grid">
          <div className="action-item">
            <span><strong>Historial médico:</strong></span>
            <button className="archivo-button">
              <img src="/src/assets/leer_historial.png" alt="Historial Médico" />
            </button>
          </div>
          <div className="action-item">
          ...
          <div className="action-item">
            <span><strong>Realizar prescripción:</strong></span>
            <Link to={`/prescripcion/${id}`}>
              <button className="prescripcion-button">
                <img src="/src/assets/realizar_prescripcion.png" alt="Prescripción" />
              </button>
            </Link>
          </div>
        </div>
